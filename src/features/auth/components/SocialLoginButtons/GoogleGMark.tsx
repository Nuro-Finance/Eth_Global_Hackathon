/**
 * Multicolor Google "G" mark (brand colors). Inline SVG so it is not forced to one `currentColor`.
 */
export default function GoogleGMark({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 48 48"
