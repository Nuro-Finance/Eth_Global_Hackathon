...
const US_DOCS: DocItem[] = [
  { id: "us_cardholder", label: "Cardholder Agreement", path: "" },
  { id: "privacy_notice", label: "Privacy Notice", path: "" },
  { id: "privacy_policy", label: "Privacy Policy", path: "" },
  { id: "esign", label: "E-Sign Disclosure and Consent", path: "" },
];

const INTL_DOCS: DocItem[] = [
  { id: "intl_cardholder", label: "International Cardholder Agreement", path: "" },
  { id: "privacy_notice", label: "Privacy Notice", path: "" },
  { id: "privacy_policy", label: "Privacy Policy", path: "" },
  { id: "esign", label: "E-Sign Disclosure and Consent", path: "" },
];
