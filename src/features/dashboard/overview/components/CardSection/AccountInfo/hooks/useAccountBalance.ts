...
export interface CardRow {
   ...
   *  on hero card overlays per Mythos Brain ticket #3 (Option A). Falls back
 ...
 * must be visible to do their job. Tuned at 600ms by Richard's spec
 * (Mythos ticket #11 — heartbeat scope conversation, 2026-05-25).
 */
