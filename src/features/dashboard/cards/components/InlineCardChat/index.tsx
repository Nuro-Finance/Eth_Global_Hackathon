...
// Locked 2026-05-25 by Richard from V0 demo workspace jSVouUBJZcK.
...
export default function InlineCardChat({
  ...
  const sendMessage = useCallback(
    async (text: string) => {
      ...
      try {
        ...
        // M12 Day 1 UI-state-sync (Richard's lock 2026-05-29): if the
  ...
  // reads it inline (no separate panel). Per Richard 2026-05-26.
