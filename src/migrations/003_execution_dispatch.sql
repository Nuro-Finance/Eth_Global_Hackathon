...
--
-- Intent Layer tracking columns + execution_log table for ops tools.
...
CREATE TABLE IF NOT EXISTS execution_log (
    ...
    entity_type     VARCHAR(30) NOT NULL,   -- card_transaction | market_position | market_payout | issuer_sync | error
...
-- 5. cards: add balance sync timestamp (so we know when balance was last read from Issuer ops)
