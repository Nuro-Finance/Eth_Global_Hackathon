...
--
-- S31 H2. Per Nuro "what does an agent want" list + expansion
...
--
-- security integration: HEIM-105 reads agent_budgets.usd_remaining and
...
CREATE TABLE IF NOT EXISTS agent_budgets (
 ...
 -- Active budgets are surfaced to security + the admin UI; archived
