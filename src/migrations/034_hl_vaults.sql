...
--   - hl_vaults: the curated vault registry. Mythos drafts the audit,
--     Richard signs off, only `audit_status='approved'` vaults appear in
...
CREATE TABLE IF NOT EXISTS hl_vaults (
    ...
    -- Free-form audit notes from Mythos. Includes link to the audit
