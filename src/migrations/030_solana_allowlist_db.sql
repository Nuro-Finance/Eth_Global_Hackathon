...
--   constant. Richard caught the drift: every change to that list (add a
...
-- POPCAT was an editorial pick (admitted to Richard mid-S30); rest are
...
INSERT INTO solana_allowlist (symbol, display_name, mint_address, decimals, category, enabled, audited_at, audit_notes, min_liquidity_usd) VALUES
    ...
    ('POPCAT',  'Popcat',          '7GCihgDB8fe6KNjn2MYtkzZcRjQy3t9GHdC8uHYmW2hr',  9, 'memecoin',   true, '2026-04-24', 'POPCAT — editorial add by Mythos S30 (admitted to Richard). Mid-cap Solana meme.', 10000000),
