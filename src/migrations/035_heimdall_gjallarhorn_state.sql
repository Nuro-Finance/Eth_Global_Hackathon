-- ─────────────────────────────────────────────────────────────────────────────
-- 035 — security agent-state-gate three-state machine
--
...
-- documented in the rule catalog § agent-state-gate.
--
-- Schema additions:
...
-- (DEFAULT 'active') because legacy code reads it; security uses its own
