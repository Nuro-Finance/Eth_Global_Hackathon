...
--
-- Lets operators (or future Mythos auto-pricing) attach a price to specific
...
-- pricing per-topic gives us a marketplace where Mythos pays Huginn for
-- counsel, Heimdall sells threat-intel feeds, etc., all settled OFF-CHAIN
...
CREATE TABLE IF NOT EXISTS agent_bus_topic_pricing (
    ...
    -- topics (e.g. mythos-audit-request goes to platform vault).
