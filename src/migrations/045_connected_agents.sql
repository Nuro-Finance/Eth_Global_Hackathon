...
--
-- Each connected_agent gets dual-tagged into our existing Heimdall stream:
...
-- Heimdall is the canonical event spine. Splitting external-agent events
-- into a sibling table would mean two queries on every dashboard render
-- and a gnarly UNION on the Mythos digest. Tag-on-the-existing-spine wins.
--
