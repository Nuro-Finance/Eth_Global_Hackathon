...
INSERT INTO schema_migrations (version, filename, applied_at, notes) VALUES
  ...
  ('005', '005_owen_webhooks.sql',                   '2026-04-10', 'pre-Owen→Issuer rename'),
  ...
  ('012', '012_rename_owen_to_issuer.sql',           '2026-04-13', 'Owen → Issuer rename'),
  ...
  ('017', '017_fix_owen_user_id_rename.sql',         '2026-04-15', NULL),
