...
-- (Richard ratified all 6 Qs on 2026-05-25 via Inbox ticket #15)
--
-- Concept (Richard's words):
...
-- ─── self_learn_reports ─────────────────────────────────────────────────────
-- The 3 reports per spec Richard's words: "learning report, risk assessment
