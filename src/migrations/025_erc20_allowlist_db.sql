...
--   token. At 20-50 tokens (Richard's goal), that's death by a thousand
...
-- Tier 1 + Tier 2 memecoin additions per Richard's Session 23 directive.
...
INSERT INTO erc20_allowlist (chain_id, symbol, display_name, contract_address, decimals, category, enabled, audited_at, audit_notes, min_liquidity_usd) VALUES
    ...
    -- Memecoins — Tier 1 (Richard approved inline Session 23)
    ...
    -- Memecoins — Tier 2 (Richard approved inline Session 23 with "extra caution")
    ...
    -- Additional — QUAI (Richard: friend owns, he mines it himself)
    (1,     'QUAI',  'Quai Network',    '0x00000000000000000000000000000000deadbeef', 18, 'memecoin', false, '2026-04-18', 'Session 23 — Richard personal add. CONTRACT ADDRESS PLACEHOLDER. Needs real 0x-verified contract before enabling. Disabled until verified.', 0)
