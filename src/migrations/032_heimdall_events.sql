-- Migration 032: Heimdall events — security plane audit log (Session 30 H1)
-- Created: 2026-04-25
--
-- Heimdall is Marathon 8 Corvus Layer 4.5 — the security plane that gates
-- every agent I/O. Phase 0 D.2 shipped the 52-rule catalog in the Neural
-- Net. This migration + the src/heimdall/ module ship the first live
-- enforcement surface in our TypeScript stack BEFORE the Rust ingress
-- proxy lands (Marathon 8 Phase 1).
--
-- Every rule trip writes a row here. Admin /admin/heimdall renders the
