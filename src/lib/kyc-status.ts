 ...
 *
 * Context: SD3 sends KYC status under different labels depending on lifecycle
 ...
 * used by the webhook normalizer at src/index.ts line ~338. If SD3 adds new
...
/**
 * Returns true if the given status string means "verified" under any of SD3's
