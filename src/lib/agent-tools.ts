 ...
 *
 * Marathon 12 Day 1 (2026-05-30). Triggered by Richard's bug 2026-05-29:
...
export interface AgentToolResult {
  ...
  error?: string;
  /**
   * UI-state-sync lock (Richard's lock 2026-05-29): tools that mutate state
