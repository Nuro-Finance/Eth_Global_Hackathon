 ...
 * It updates cards.is_locked in Postgres and should call Issuer API to
 * suspend/activate the card at the payment processor level.
 *
 * Issuer suspend: POST /cards/{issuerCardId}/suspend
 * Issuer activate: POST /cards/{issuerCardId}/resume  (or PATCH with status)
 */
