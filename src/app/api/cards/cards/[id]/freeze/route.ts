 ...
 * It updates cards.is_locked in Postgres and should call Owen API to
 * suspend/activate the card at the payment processor level.
 *
 * Owen suspend: POST /cards/{owenCardId}/suspend
 * Owen activate: POST /cards/{owenCardId}/resume  (or PATCH with status)
 */
