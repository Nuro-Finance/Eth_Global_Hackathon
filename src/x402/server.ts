...
// payment. Together they close the loop: Mythos can pay Nuro endpoints for
...
//     Mythos's vault funds calls; revenue vault collects them.
 ...
 *
 * Note: the SD3 issuer + bridge stack already use HD derivation from the
