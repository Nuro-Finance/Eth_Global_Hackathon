...
//
//   - Internal payers (HD-derived agent vaults — Mythos, Huginn, system,
...
//
// Operator workflow to point Mythos's client at us:
 ...
 * vaults. Pre-S33-X5 had only 'mythos' / 'system' / 'nuro-revenue';
...
function isInternalAgentAddress(addr: string): { isInternal: boolean; agentId: string | null } {
  const candidates = ['mythos', 'huginn', 'system', 'nuro-revenue']
