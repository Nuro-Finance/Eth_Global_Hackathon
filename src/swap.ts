 ...
 *   - Slippage: 300 bps (3%) per Richard's MVP call. Configurable via
 ...
 *     audit required before adding any ERC-20 (Richard's call).
 */
...
export async function executeNativeToUsdcSwap(
    ...
    try {
        ...
        // Helm HELM-105 — value cap on native→USDC swap. quote.buyAmountUsd
...
export async function executeErc20ToUsdcSwap(
    ...
    try {
        ...
        // Helm HELM-105 — value cap on ERC-20→USDC swap. Check BEFORE
