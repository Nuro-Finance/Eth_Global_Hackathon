...
export const CONFIG = {
    ...
    ISSUER_API_BASE: process.env.ISSUER_API_BASE || process.env.OWENS_API_BASE!,
    ISSUER_API_KEY: process.env.ISSUER_API_KEY || process.env.OWENS_API_KEY!,
    ...
    // Slippage in basis points. 300 = 3% — Richard's MVP default (Session 23).
    ...
    // gas on a $2 swap. Richard's MVP default: $5.
    ...
    // partner confirmations land (Owen for SD3 card-debit API; Dwolla+Plaid sandbox
    ...
    // REFUSES to initiate any LZ send via bridge.ts, admin console action,
