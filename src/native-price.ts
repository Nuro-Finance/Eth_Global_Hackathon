...
//
// S31 H2. Built specifically for HELM-105 tx-cap coverage on the call sites
...
//     caller can pass NaN to enforceTxCap and skip the gate (per HELM-105
//     contract, NaN value = "skip silently, don't block on bad inputs")
//   - No new deps — reuses fetchCoinPrice from market-feeds.ts which has
//     the existing axios + error-reporting plumbing

import { fetchCoinPrice } from './market-feeds'
 ...
 * enforceTxCap recognizes as "skip the cap check" (per HELM-105 contract:
