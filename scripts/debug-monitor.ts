...
async function main() {
  ...
  const txRes = await pool.query(
    "SELECT id, source_chain, amount, status FROM transactions WHERE user_id IN (SELECT id FROM users WHERE owen_user_id = '72459d0e-8705-4b5d-bb40-904e4ae8a3a1') AND source_chain = 1"
  );
