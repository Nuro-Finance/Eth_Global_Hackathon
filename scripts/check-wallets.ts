...
const WALLETS: [string, string][] = [
  ...
  // Richard personal
  ['Richard Wallet 1', '0xa0825f3787a4a2625ea43780302Fe07846C2C6A8'],
  ['Richard Wallet 2', '0x7c10E5D7Ad72fD38bD391AD78f8DD44efBA5EC6a'],
  ['Richard Wallet 3 (Deployer)', '0x27FbEAD2B527AaDAf4EA7B3Af065244A3964ECBC'],
  ['Richard Unknown', '0x29fcB43b46531BcA003ddC8FCB67FFE91900C762'],
  // Corporate
  ['Memetropolis Safe', '0x65f5B35397838C7165A705EA883De4bEB1212b1f'],
  ['GBlock Safe', '0x6C9b06CB243f0fB9a535a90414721deAb9970879'],
  // Richard additional
  ['Richard Wallet 4', '0x27d1a5E61a0dC3D650F4ae81ed3675Dc2802c2D1'],
  // Owen Base contract
  ['Owen Base Contract', '0x34e81c59B814874611C7FB66661B57E599b4857D'],
];
